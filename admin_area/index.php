    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                /*Wiki*/
                if (isset($_GET['insert_wiki'])) {

                    include("insert_wiki.php");

                }

                if (isset($_GET['view_wiki'])) {

                    include("view_wiki.php");

                }

                if (isset($_GET['delete_wiki'])) {

                    include("delete_wiki.php");
                ...
                if (isset($_GET['insert_ee'])) {

                    include("insert_ee.php");

                }

                if (isset($_GET['view_ee'])) {

                    include("view_ee.php");

                }

                if (isset($_GET['delete_ee'])) {

                    include("delete_ee.php");
