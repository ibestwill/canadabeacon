...
if (!isset($_SESSION['admin_email'])) {
            ...
            <div class="panel panel-default"><!-- panel panel-default Starts -->
                ...
                <div class="panel-heading"><!-- panel-heading Starts -->
                    ...
                    <h3 class="panel-title">
                        ...
                        <i class="fa fa-money fa-fw"></i> Insert Wiki
                ...
                <div class="panel-body"><!-- panel-body Starts -->
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <label class="col-md-3 control-label"> Wiki Title </label>
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <label class="col-md-3 control-label"> Wiki Url </label>
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <label class="col-md-3 control-label"> Wiki Image </label>
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="submit" name="submit" value="Insert Wiki"
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($run_post) {
            ...
            echo "<script>alert('Wiki has been inserted successfully')</script>";

            echo "<script>window.open('index.php?view_wiki','_self')</script>";

        }else{

            echo "<script>alert('Wiki failed to insert')</script>";
        }
